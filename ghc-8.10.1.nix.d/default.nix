  ...
  extras = hackage:
    {
      packages = {
        ...
        "ghc-lib" = (((hackage.ghc-lib)."8.10.2.20200916").revisions).default;
        "ghc-lib-parser" = (((hackage.ghc-lib-parser)."8.10.2.20200916").revisions).default;
        ...
        "ormolu" = (((hackage.ormolu)."0.1.4.1").revisions).default;
